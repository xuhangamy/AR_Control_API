/**
 * @file video_encapsulation.h
 * @brief 视频相关数据结构，来自于ardrone官方sdk。
 * 
 */
#ifndef _TK_VIDEO_ENCAPSULATION_H_
#define _TK_VIDEO_ENCAPSULATION_H_
...
namespace whu {
	namespace ardrone {
		...
		int init_parrot_video_encapsulation_header(parrot_video_encapsulation_t * header);
...
#endif // _TK_VIDEO_ENCAPSULATION_H_